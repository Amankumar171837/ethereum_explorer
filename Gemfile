...
gem 'kaminari', '>= 1.2.1'
gem 'peatio', git: 'https://github.com/urkishan/peatio-core', branch: 'feature/added-decode-method'
gem 'rack-cors', '~> 1.0.2'
...
gem 'jwt_sessions', git: "https://github.com/urkishan/jwt_sessions", branch: 'feature/redis-cluster'
gem 'bunny'
gem 'phonelib',     '~> 0.6.45'
...
# Support for database read/write replica
gem 'makara'

# To check if the email is valid or not
gem 'sendgrid-ruby'

# To add count for the relational table data
...
gem 'turnstile-ruby', git: 'https://github.com/urkishan/turnstile-ruby', require: 'turnstile'

gem 'rdkafka'
gem 'chewy', git: 'https://github.com/urkishan/chewy.git', branch: 'fix/i18n-core_ext'
