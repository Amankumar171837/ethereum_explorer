      ...
      class Restrictions < Grape::API
        resource :restrictions do
          ...
          get do
            ...
            restrictions = params[:to] ? restrictions.where("#{params[:range]}_at <= ?", params[:to]) : restrictions
            restrictions = params[:from] ? restrictions.where("#{params[:range]}_at >= ?", params[:from]) : restrictions
