  ...
  module Entities
    class Profile < API::V2::Entities::Base
      expose :first_name,
        ...
        Barong::App.config.api_data_masking_enabled ? profile.sub_masked_first_name : profile.first_name
      end

      expose :middle_name,
             documentation: {
               type: 'String',
               desc: 'Submasked middle name'
             } do |profile|
        Barong::App.config.api_data_masking_enabled ? profile.sub_masked_middle_name : profile.middle_name
      end
